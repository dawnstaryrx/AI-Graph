                ...
                <div class="widget-body am-cf">
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                        <div class="widget-card card__blue am-cf">
                            <div class="card-header">平台访问</div>
                            <div class="card-body">
                                <div class="card-value"><?= $data['views_total'] ?></div>
                                <div class="card-description">当前平台访问数量</div>
                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                        <div class="widget-card card__violet am-cf">
                            <div class="card-header">平台数</div>
                            <div class="card-body">
                                <div class="card-value"><?= $data['apps_total'] ?></div>
                                <div class="card-description">后台平台数</div>
                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                        <div class="widget-card card__primary am-cf">
                            ...
                            <div class="card-body">
                                <div class="card-value"><?= $data['modules_total'] ?></div>
                                <div class="card-description">后台应用总量</div>
