                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    ...
                                    <div class="help-block am-margin-top-xs">
                                        <small>模板编号AT0009，关键词 (订单编号、支付时间、订单金额、设备名称)</small>
                                    </div>
                                </div>
                            </div>

                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">洗车完成通知</div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label form-require">
                                    是否启用
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    ...
                                    <small>模板编号AT0007，关键词 (订单编号、设备信息)</small>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    ...
                                    <small>模板编号AT0553，关键词 (售后类型、状态、订单号、设备名称、申请时间、申请原因)</small>
                                </div>
                            </div>
                            <div class="am-form-group">
