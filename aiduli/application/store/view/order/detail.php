        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget__order-detail widget-body am-margin-bottom-lg">
                        ...
                        <ul class="order-detail-progress progress-<?= $progress ?>">
                            ...
                            <li>
                                ...
                                <?php if ($detail['delivery_status']['value'] == 20): ?>
                                    <div class="tip">
                                        洗车于 <?= date('Y-m-d H:i:s', $detail['delivery_time']) ?>
                                    </div>
                                <?php endif; ?>
                            </li>
                            <li>
                                ...
                                <?php if ($detail['receipt_status']['value'] == 20): ?>
                                    <div class="tip">
                                        洗车完毕 <?= date('Y-m-d H:i:s', $detail['receipt_time']) ?>
                                    </div>
                                <?php endif; ?>
                            </li>
                            <li>
                    ...
                    <div class="am-scrollable-horizontal">
                        <table class="regional-table am-table am-table-bordered am-table-centered
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="am-badge am-badge-secondary">自主洗车</span>
                                </td>
                                <td>
                                    <p>付款状态：
                                        <span class="am-badge
                    ...
                    <!-- 设备信息 -->
                    <div class="widget-head am-cf">
                        <div class="widget-title am-fl">设备信息</div>
                    </div>
                    <div class="am-scrollable-horizontal">
                        <table class="regional-table am-table am-table-bordered am-table-centered
                            am-text-nowrap am-margin-bottom-xs">
                    ...
                    <?php if ($detail['delivery_type']['value'] == DeliveryTypeEnum::EXTRACT): ?>
                        <?php if (!empty($detail['extract'])): ?>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">信息</div>
                            </div>
                    ...
                    <?php if (
                        ...
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">洗车信息</div>
                        </div>
