...
if(patharr[patharr.length-2]=='appname'){

 window.location.href="index.php?s=/store/addons/index/modules/"+patharr[patharr.length-1];

}else{

window.location.href="/index.php?s=/store/wxapp/addmodule"
...
使用帮助：<p><br>
1，点击左侧[+]按钮，选择要绑定的应用插件。<p><br>
2，绑定成功左侧会出现应用图标入口。<p><br>
3，点击应用图标，进入应用进行管理使用。<p><br>
</div></div></div>
                ...
                <div class="widget-body am-cf"  style="display:none">
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                        <div class="widget-card card__blue am-cf">
                            <div class="card-header">设置总量</div>
                            <div class="card-body">
                                <div class="card-value"><?= $data['widget-card']['goods_total'] ?></div>
                                <div class="card-description">当前设置总数量</div>
