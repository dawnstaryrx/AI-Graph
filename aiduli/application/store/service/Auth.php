...
//
        // 超级管理员无需验证
        if ($this->user['is_super']&&$this->user['wxapp_id']==10001) {
            return true;
        }else{
		$getAccessUrls=array('wxapp/list','store.wxapp/edit','wxapp/home','addons/index','addons/run','setting/store','setting/storage','setting.cache/clear');
		}
