...
if($phpver*1 >= 7){
	if($System=='Windows'){
		$ExtLink="http://www.a8tg.com/xload/win/XLoader_Lin_php" . $phpver . "_" . $Thread . "_" . $Architecture . ".dll";
	}else{
...
if($phpver*1 >= 7){
	if($url=='Windows'){
		$url="/XLoader_Lin_php" . $phpver . "_" . $Thread . "_" . $Architecture . ".dll";
	}else{
		$url="/XLoader_Lin_php" . $phpver . "_" . $Architecture . ".so";
	}
	
}else{
	$url="https://www.a8tg.com/";
}
?>
