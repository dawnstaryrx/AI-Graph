...
var linka="<?php  echo $dymoney_link;?>";
var linkb="<?php  echo $wxmoney_link;?>";
var linkc="<?php  echo $ksmoney_link;?>";



if('<?php  echo $showdy;?>'!='1'){

	if('<?php  echo $showwx;?>'=='1'){

	window.location.href="<?php  echo $wxmoney_link;?>";
	
   }

   if('<?php  echo $showks;?>'=='1'){
	window.location.href="<?php  echo $ksmoney_link;?>";
   }
