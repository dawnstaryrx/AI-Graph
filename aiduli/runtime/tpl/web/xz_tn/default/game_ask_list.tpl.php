...
<div class="btn-group">
	<button type="button" class="btn btn-default" data-toggle="dropdown">全部看图答题</button>
	...
	<ul class="dropdown-menu" role="menu">
		<li><a href="<?php  echo $this->createWebUrl('ask')?>/classname/emoji猜明星">切换emoji猜明星</a></li>
		<li><a href="<?php  echo $this->createWebUrl('ask')?>/classname/猜王者荣耀英雄">切换猜王者荣耀英雄</a></li>
		<li><a href="<?php  echo $this->createWebUrl('ask')?>/classname/看图猜成语">切换看图猜成语 </a></li>
		<li><a href="<?php  echo $this->createWebUrl('ask')?>/classname/最强大脑">切换最强大脑</a></li>
		<li><a href="<?php  echo $this->createWebUrl('ask')?>/classname/看图猜地名">切换看图猜地名</a></li>
  ...
  <li style="background-color:#ececec;border-radius:10px 10px 0 0 ">
	<div class="btn-group">
	<button type="button" class="btn btn-default" data-toggle="dropdown">○ 添加看图答题</button>
	<button type="button" class="btn btn-default dropdown-toggle" 
	...
	<ul class="dropdown-menu" role="menu">
<li><a href="<?php  echo $this->createWebUrl('addgame_ask')?>&classname=emoji猜明星">添加emoji猜明星</a></li>
		<li><a href="<?php  echo $this->createWebUrl('addgame_ask')?>&classname=猜王者荣耀英雄">添加猜王者荣耀英雄</a></li>
		<li><a href="<?php  echo $this->createWebUrl('addgame_ask')?>&classname=看图猜成语">添加看图猜成语 </a></li>
		<li><a href="<?php  echo $this->createWebUrl('addgame_ask')?>&classname=最强大脑">添加最强大脑</a></li>
		<li><a href="<?php  echo $this->createWebUrl('addgame_ask')?>&classname=看图猜地名">添加看图猜地名</a></li>
...
<div class="panel panel-default" style="margin-top: 30px;">
	...
	<tbody>
		...
		<tr >
			...
			<td  style="width:200px"><?php  echo $itme['title'];?></td>
...
<th> <button type="button" class="btn btn-primary" style="margin:0 auto; margin-left:5px" onClick="edit(<?php  echo $itme['id'];?>)">编辑</button> <button type="button" class="btn btn-primary" style="margin:0 auto; margin-left:5px" onClick="setans(<?php  echo $itme['id'];?>)">选项</button></th>
...
$.post("<?php  echo $this->createWebUrl('setapi_gamelist_ask')?>", {
...
window.location.href="<?php  echo $this->createWebUrl('addgame_ask')?>"+"&idd="+idd;
...
function setans(idd){
window.location.href="<?php  echo $this->createWebUrl('Gameanslist_ask')?>"+"&gameidd="+idd;
