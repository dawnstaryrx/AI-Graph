...
<div style="margin-top:-20px;width:auto;height:auto;background-color:#fff;border-radius:10px"> <a href='<?php  echo $infolink;?>'><button style="position:absolute;float:right;box-shadow: 0px 0px 10px #1430da;margin-top:18px; width:180px height:60px; text-align:center; line-height:40px;z-index:100;font-size:17px;po;background:#1430da;border:1px solid  ce6766;color:#fff;border-radius:10px;width:120px;color:#fff;margin-left:100px" >完善资料</button></a>
	 ...
	 <div  style="width:100%;height:auto; overflow:hidden;padding:0px">
	  ...
	  <div style="height:5px"></div>
        <img src="<?php  echo $rootpath;?><?php  echo $config_db['s_pic'];?>" style="box-shadow:3px 3px 15px #eeedf4;margin-left:-15px;border-radius:200px;width:65px;height:65px"/>
      </div>
      <div style="width:auto;height:auto;float:left;margin-left:-20px;">
       ...
       <div style="width:100%;height:10px;background-color:#ffffff"></div>
		...
		<!--个人资料-->		
 <a  href="<?php  echo $newlink;?>"> <img  src="/addons/xz_tn/topimg.jpg" style="width:100%;height:auto;border-radius:15px"/></a>

<div style="width:100%;height:auto;border:2px solid #000;border-radius:20px;overflow:hidden">

	 <a href="<?php  echo $newlink;?>"><button style="position:absolute;float:right;box-shadow: 0px 0px 10px #1430da;margin-top:18px; width:180px height:60px; text-align:center; line-height:40px;z-index:100;font-size:17px;po;background:#b90404;border:1px solid  ce6766;color:#fff;border-radius:10px;width:120px;color:#fff;;margin-left:-20px" >如何变现？</button></a>
...
<!---->
				...
				<a href="<?php  echo $moneypage;?>" target="_blank"><div class="submit" style="width:100%;height:150px;background-color:#0bd38a;border-radius:15px;line-height:20px;font-align:center;color:#fff;">
				<div style="height:30px"></div>
				<font style="font-size:50px;font-weight:bold">+</font><br>
				<div style="height:10px"></div>
				<font style="font-size:24px;font-weight:bold;margin-top:20px">查看收益</font><br>
				<div style="height:10px"></div>
				<font style="font-size:18px;color:#b3ffe3">(分享裂变流量变现)</font>
				</div></a>
...
window.location.href=' <?php  echo $_W['siteroot']?>index.php?c=site&a=entry&do=user&module_name=xz_tn&uid=<?php  echo $_W['uniacid']?>';
return;
