...
<link href="../../../addons/xz_tn/css/style.css" rel='stylesheet' type='text/css' />
	...
	<script type="text/javascript" src="../../../addons/xz_tn/template/libs/com.js"></script>
		...
		<script type="text/javascript" src="../../../addons/xz_tn/template/libs/jquery.monthpicker_user.js"></script>
...
<a href="<?php  echo $backlink;?>"><button  type="button" class="btn btn-primary btn-lg" style="position:absolute;top:50px;left:100%;margin-left:-150px">返回首页</button></a>
</div>
