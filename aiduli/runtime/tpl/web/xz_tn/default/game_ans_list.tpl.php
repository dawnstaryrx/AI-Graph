...
<li  style="background-color:#ececec;border-radius:10px 10px 0 0 "><a href="<?php  echo $this->createWebUrl('find')?>">返回</a></li>
  <li class="active"><a href="<?php  echo $this->createWebUrl('Gameanslist')?>">答案列表</a></li>
  <li style="background-color:#ececec;border-radius:10px 10px 0 0 "><a href="<?php  echo $this->createWebUrl('Addgameans')?>&gameidd=<?php  echo $_GPC['gameidd']?>">○ 添加答案</a></li>
</ul>
...
<td><?php  echo $itme['posx'];?></td>
<td><?php  echo $itme['posy'];?></td>
...
function del(){
	...
	function delfun(){
		...
		$.post("<?php  echo $this->createWebUrl('setapi_gamelist_ans')?>", {
...
window.location.href="<?php  echo $this->createWebUrl('Addgameans')?>"+"&idd="+idd+"&gameidd=<?php  echo $_GPC['gameidd']?>";
