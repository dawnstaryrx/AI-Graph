...
<div class="btn-group">
    ...
    <a href="<?php  echo $this->createWebUrl('money_ks')?>"><button type="button" class="btn btn-default btn-lg active" style="border-radius:10px 10px 0 0">快手结算</button></a>
</div>
...
window.location.href="<?php  echo $this->createWebUrl('Money_ks')?>&type=showorder&start_time="+start+"&end_time="+end;
...
window.location.href="<?php  echo $this->createWebUrl('Money_ks')?>&type=showorder&start_time="+timeArr_day[0]+"&end_time="+timeArr_day[1];
...
window.location.href="<?php  echo $this->createWebUrl('Money_ks')?>&type=showorder&start_time="+timeArr[0]+"&end_time="+timeArr[1];
...
$.post("<?php  echo $this->createWebUrl('download_usercode_ks')?>", {
