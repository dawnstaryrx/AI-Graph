...
<li class="active"><a href="<?php  echo $huoshan_link;?>">火山接口</a></li>
...
$.post("<?php  echo $this->createWebUrl('huoshan')?>", {
			...
			id:idd
				 ...
				 var obj = JSON.parse(data);
				 	 if(obj['res']==1){
alertf('删除成功','提醒',function(){window.location.href="<?php  echo $this->createWebUrl('huoshan')?>"+'&ptype='+GetQueryString('ptype') })
				 }else{
...
pw: $('#pw').val(),
			...
			pid:GetQueryString('ptype'),
			 imgpath:$('input[name="s_pic"]').val(),
				 ...
				 var obj = JSON.parse(data);
				 	 if(obj['res']==1){
alertf('操作成功','提醒',function(){window.location.href="<?php  echo $this->createWebUrl('huoshan')?>"+'&ptype='+GetQueryString('ptype') })
				 }else{
				   window.alertf(obj['res'])
				 }
...
return;
	...
	function edit(idd){
		...
		window.location.href="<?php  echo $this->createWebUrl('huoshan')?>"+"&type=edit&id="+idd+'&ptype='+GetQueryString('ptype')
...
function my(idd,str){
	...
	$.post("<?php  echo $this->createWebUrl('myhuoshan')?>", {
