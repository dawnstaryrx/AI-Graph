...
<div class="form-group"  >
        ...
        <div class="col-sm-10">
         <select id="targetid">
  <option value ="0" <?php  if($config_db['targetid']==0) { ?>selected<?php  } ?>>随机 </option>
  <option value ="1" <?php  if($config_db['targetid']==1) { ?>selected<?php  } ?>>推荐 </option>
     ...
     <div class="form-group"   style="">
        <label for="firstname" class="col-sm-2 control-label">AI绘画灵感</label>
        <div class="col-sm-10">
                 <input type="text" id="money" class="form-control" value="<?php  echo $config_db['money'];?>">
        AI绘画一次消耗多少灵感（平台限制：未充值是画4张）
        </div>
      </div>
 ...
 <select id="wenxin">
  <option value ="0" <?php  if($config_db['wenxin']==0) { ?>selected<?php  } ?>>未充值 </option>
  <option value ="1" <?php  if($config_db['wenxin']==1) { ?>selected<?php  } ?>>已充值 </option>
</select>
...
未充值，画一次消耗4张（注意调整价格）。充值后一次性画1张。（文心平台限制）
	  ...
	  <div class="form-group"   style="">
        ...
        <div class="col-sm-10">
                 <input type="text" id="money_a" class="form-control" value="<?php  echo $config_db['money_a'];?>">
        图转卡通一次消耗多少灵感
        </div>
      </div>
	  ...
	  <div class="form-group"   style="">
        ...
        <div class="col-sm-10">
                 <input type="text" id="money_b" class="form-control" value="<?php  echo $config_db['money_b'];?>">
        欧系卡通一次消耗多少灵感
        </div>
      </div>
	  ...
	  <div class="form-group"   style="">
        ...
        <div class="col-sm-10">
                 <input type="text" id="money_c" class="form-control" value="<?php  echo $config_db['money_c'];?>">
        图生动态效果一次消耗多少灵感
        </div>
      </div>
	  ...
	  <div class="form-group"   >
        <label for="firstname" class="col-sm-2 control-label">图换表情</label>
        <div class="col-sm-10">
                 <input type="text" id="money_d" class="form-control" value="<?php  echo $config_db['money_d'];?>">
        图换表情消耗多少灵感
        </div>
      </div>

	  <div class="form-group" >
        <label for="firstname" class="col-sm-2 control-label">变脸换脸消耗</label>
        <div class="col-sm-10">
                 <input type="text" id="money_e" class="form-control" value="<?php  echo $config_db['money_e'];?>">
       变脸换脸消耗多少灵感
        </div>
      </div>
	  ...
	  <div class="form-group" >
        ...
        <div class="col-sm-10">
                 <input type="text" id="money_f" class="form-control" value="<?php  echo $config_db['money_f'];?>">
      3D游戏脸消耗多少灵感
        </div>
      </div>
 ...
 <div class="form-group"  style="display:none"   >
	  ...
	  <div class="form-group"  >
        ...
        <div class="col-sm-10">
          <input type="text" id="btnurl" class="form-control" value="<?php  echo $config_db['btnurl'];?>">如果添加的是推文，将跳转到推文链接。
        </div>
      </div>
...
var db_var=["woa_name","sharemode","fad","wx_id","wx_pw","ks_id","ks_pw","tt_id","tt_pw","ks_comead","ks_addad","wx_comead","wx_addad","wx_banner","wx_videoad","btnname","limit","targetid","money","money_a","money_b","money_c","money_d","money_e","money_f","apipath","title","token","wenxin","wtimes","btnurl","imgurl","comead","addad","s_title","pay","show","teampay","idd"]
