...
<div class="btn-group">
	<button type="button" class="btn btn-default" data-toggle="dropdown">全部图片</button>
	...
	<ul class="dropdown-menu" role="menu">
		<li><a href="<?php  echo $this->createWebUrl('list')?>&classname=苹果">苹果</a></li>
		<li><a href="<?php  echo $this->createWebUrl('list')?>&classname=汪汪队">汪汪队</a></li>
		<li><a href="<?php  echo $this->createWebUrl('list')?>&classname=恐龙">恐龙</a></li>
		<li><a href="<?php  echo $this->createWebUrl('list')?>&classname=女孩">女孩</a></li>
		<li><a href="<?php  echo $this->createWebUrl('list')?>&classname=箱子">箱子</a></li>
		<li><a href="<?php  echo $this->createWebUrl('list')?>&classname=五星">五星</a></li>
		<li><a href="<?php  echo $this->createWebUrl('list')?>&classname=佩琪">佩琪</a></li>
	</ul>
</div>
  ...
  <li style="background-color:#ececec;border-radius:10px 10px 0 0 ">
	...
	<div class="btn-group">
	<button type="button" class="btn btn-default" data-toggle="dropdown">○ 添加图片</button>
	<button type="button" class="btn btn-default dropdown-toggle" 
			data-toggle="dropdown">
		<span class="caret"></span>
		<span class="sr-only">切换下拉菜单</span>
	...
	<ul class="dropdown-menu" role="menu">
		<li><a href="<?php  echo $this->createWebUrl('addpic')?>&classname=苹果">苹果</a></li>
		<li><a href="<?php  echo $this->createWebUrl('addpic')?>&classname=汪汪队">汪汪队</a></li>
		<li><a href="<?php  echo $this->createWebUrl('addpic')?>&classname=恐龙">恐龙</a></li>
		<li><a href="<?php  echo $this->createWebUrl('addpic')?>&classname=女孩">女孩</a></li>
		<li><a href="<?php  echo $this->createWebUrl('addpic')?>&classname=箱子">箱子</a></li>
		<li><a href="<?php  echo $this->createWebUrl('addpic')?>&classname=五星">五星</a></li>
		<li><a href="<?php  echo $this->createWebUrl('addpic')?>&classname=佩琪">佩琪</a></li>
	</ul>
</div>
...
<div class="panel panel-default" style="margin-top: 30px;">
	...
	<tbody>
		...
		<tr >
			...
			<td><img src="<?php  echo $root_path;?><?php  echo $itme['imgpathb'];?>" style="width:100px; height:auto"></td>
