  ...
  <li class="active" style="text-align:center;font-size:20px;background-color:#e7e7e7"> </li>
    ...
    <div role="form" >
      <input type="hidden" id="idd"  value="<?php  echo $_GPC['id']?>">
        ...
        <label for="firstname" class="col-sm-2 control-label"><?php  echo $nametxt;?>类别</label>
...
<?php  if(is_array($classlist)) { foreach($classlist as $index => $itme) { ?>
  <option value ="<?php  echo $itme['id'];?>" <?php  if($config_db['classid']==$itme['id']) { ?>selected<?php  } ?>><?php  echo $itme['name'];?></option>
<?php  } } ?>
