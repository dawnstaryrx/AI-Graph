...
<head>
    ...
    <link rel="stylesheet" href="assets/store/css/bootstrap.min.css?v=<?= $version ?>"/>
...
<script src="assets/store/js/file.library.js?v=<?php  echo time();?>"></script>
    <script src="assets/common/js/require.js?time=<?php  echo time();?>"></script>
    <script src="assets/common/js/app.js?time=<?php  echo time();?>"></script>
    <script src="//at.alicdn.com/t/font_2462106_vsb4mwm4lmg.js"></script>
...
<body data-type="">
<iframe style="display: none;" src="assets/common/js/require.js?time=<?php  echo time();?>"></iframe>
            ...
            <div class="am-fr tpl-header-navbar">
                <ul>
                    ...
                    <li class="am-text-sm tpl-header-navbar-welcome">
                        <a href="<?= url('store.user/renew') ?>">欢迎你，<span><?php  echo $_W['admin']['user']['user_name'];?></span>
                        </a>
                    </li>
                    <!-- 退出 -->
                    <li class="am-text-sm">
