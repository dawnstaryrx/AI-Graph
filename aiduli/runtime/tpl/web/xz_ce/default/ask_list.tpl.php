...
$.post("<?php  echo $this->createWebUrl('ask')?>", {
...
window.location.href="<?php  echo $this->createWebUrl('ask')?>"+"&type=edit&listid="+<?php  echo $_GPC['listid']?>	
...
return;
	...
	function edit(idd){
		...
		window.location.href="<?php  echo $this->createWebUrl('ask')?>"+"&type=edit&id="+idd+"&listid="+<?php  echo $_GPC['listid']?>	
