...
<a href="<?php  echo $addlink;?>&ptype=<?php  echo $ptype;?>"><button  type="button" class="btn btn-primary">添加测试</button></a>
...
<select id="hot<?php  echo $itme['id'];?>"  data-toggle="tooltip" data-placement="top" onchange="setapi(<?php  echo $itme['id'];?>,'hot')">
  ...
  <option value ="1" <?php  if($itme['hot']==1) { ?>selected<?php  } ?>>首页</option>
	...
	<td >   
<select id="hid<?php  echo $itme['id'];?>"  data-toggle="tooltip" data-placement="top" onchange="setapi(<?php  echo $itme['id'];?>,'hid')">
  <option value ="0" <?php  if($itme['hid']!=1) { ?>selected<?php  } ?>>显示</option>
  <option value ="1" <?php  if($itme['hid']==1) { ?>selected<?php  } ?>>隐藏</option>
</select>
</td>
<td><?php  echo $itme['classid'];?></td>
...
function editfun(ee){
	...
	function ask(ee){
			window.location.href="<?php  echo $this->createWebUrl('Ask')?>&listid="+ee; 

	}

		function ans(ee){
			window.location.href="<?php  echo $this->createWebUrl('ans')?>&listid="+ee; 
