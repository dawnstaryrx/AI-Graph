...
<div class="panel panel-default">
	...
	<li class="active"><a href="<?php  echo $config_link;?>" style="font-size:20px;;border-radius:100px;">导航管理</a></li>
...
$.post("<?php  echo $this->createWebUrl('menu')?>", {
			...
			id:idd
				 ...
				 var obj = JSON.parse(data);
				 	 if(obj['res']==1){
alertf('删除成功','提醒',function(){window.location.href="<?php  echo $this->createWebUrl('menu')?>" })
				 }else{
...
$.post("<?php  echo $this->createWebUrl('menu')?>", {
			...
			picon: $('input[name="picon"]').val(),
				 ...
				 var obj = JSON.parse(data);
				 	 if(obj['res']==1){
alertf('操作成功','提醒',function(){window.location.href="<?php  echo $this->createWebUrl('menu')?>" })
				 }else{
				   window.alertf(obj['res'])
				 }
...
return;
	...
	function edit(idd){
		...
		window.location.href="<?php  echo $this->createWebUrl('menu')?>"+"&type=edit&id="+idd	
