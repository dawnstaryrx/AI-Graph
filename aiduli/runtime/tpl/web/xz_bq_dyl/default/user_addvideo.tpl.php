...
<div class="panel panel-default"  style="margin:20px;width:96%;margin-left:2%">
    ...
    <div role="form" style="border-radius:00px">
      <input type="hidden" id="idd"  value="<?php  echo $idd;?>">


	    <div class="form-group" style="height:00px">


     

        <div class="col-sm-12">
<div class="mui-input-cell" style=";display:none"> 

<select id="classid"  class="form-control" style="height:60px;font-size:24px;line-height:60px;display:none">
...
<?php  } } ?>
 ...
 <div class="form-group" style="height:00px;margin-top:10px">
 </div>
    <div class="form-group" style="height:00px;margin-top:30px">
...
<select onChange="showmode(this.value)" id="mode"  class="form-control" style="height:60px;font-size:24px;line-height:0px;display:none">
...
<div class="form-group"  id="inputB" >
...
<div style="height:60px;width:100%"  class="col-sm-12"></div>
	   ...
	   <div class="form-group col-sm-12" style="clear:left"  >
        ...
        <div class="col-sm-12">
          <button id="subbtn" class="btn btn-primary btn-lg"  onClick="add()" style="width:100%;height:60px;font-size:24px;clear:left" >发布视频</button>
<br>
		  <div style="color:#e70000;font-size:22px"><div style="height:20px"></div>请控制视频尺寸，尽量压缩到最低，上传时请耐心等待上传完成。</div>
...
if($('#video_inputfile')[0].files.length==0){
	alertf('必须选择视频')
	return;
}
...
$("#subbtn").html('上传中请等待')
        ...
        //发送数据
        $.ajax({
            url:"<?php  echo $postlink;?>/imgid/<?php  echo $_GPC['imgid']?>", /*去过那个php文件*/
            type:'POST',  /*提交方式*/
            data:data,
            cache: false,
