...
<li class="active" style="float:right; position:absolute;left:95%;;margin-left:-300px" ><a href="<?php  echo $feedback_link;?>" style="border-radius:5px;font-size:20px;width:300px;background-color:#faa048">学徒/入驻报名(<?php  echo $feedback_num?>)</a></li>
</ul>
<div class="btn-group">
    <a href="<?php  echo $this->createWebUrl('pay')?>"><button type="button" class="btn btn-primary btn-lg " style="border-radius:10px 10px 0 0">抖音收益管理</button ></a>
    <a href="<?php  echo $this->createWebUrl('pay_wx')?>"><button type="button" class="btn btn-default btn-lg active" style="border-radius:10px 10px 0 0">微信收益管理</button></a>
...
function showdetail(ee,idd){
	window.location.href="<?php  echo $this->createWebUrl('detail_wx')?>&o_time="+ee+"&shopid="+idd
