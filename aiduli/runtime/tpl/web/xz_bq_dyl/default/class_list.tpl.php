...
<div class="panel panel-default">
	...
	<li class="active"><a href="<?php  echo $backlink;?>" style="font-size:20px;">返回</a></li>
  <li class="active" style="text-align:center;font-size:20px;background-color:#e7e7e7">分类管理</li>
      ...
      <input type="hidden" id="idd"  value="<?php  echo $idd;?>">
	   ...
	   <div class="form-group" style="height:30px">
        ...
        <div class="col-sm-10">
         ...
         <select id="pid">
  <option value ="0" <?php  if($config_db['pid']<=3) { ?>selected<?php  } ?>>表情包 </option>
  <option value ="4" <?php  if($config_db['pid']==4) { ?>selected<?php  } ?>>头像 </option>
  <option value ="5" <?php  if($config_db['pid']==5) { ?>selected<?php  } ?>>壁纸 </option>
   <option value ="6" <?php  if($config_db['pid']==6) { ?>selected<?php  } ?>>背景图 </option>
</select>
...
<div class="panel panel-default">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php  echo $itme['name'];?></td>
				<td><?php  if($itme['pid']<=3) { ?>表情包<?php  } else if($itme['pid']==4) { ?>头像<?php  } else if($itme['pid']==5) { ?>壁纸<?php  } else if($itme['pid']==6) { ?>背景图<?php  } ?></td>
  ...
  <option value ="1" <?php  if($itme['my']==1) { ?>selected<?php  } ?>>隐藏</option>
			...
			<button  class="btn btn-danger" onClick="del(<?php  echo $itme['id'];?>)">删除</button>
				<button  class="btn btn-success" onClick="auto(<?php  echo $itme['id'];?>,<?php  echo $itme['pid'];?>)">采集</button>
...
function auto(idd,pid){
window.location.href="<?php  echo $this->createWebUrl('auto')?>"+"&classid="+idd+"&ptype="+pid
}
