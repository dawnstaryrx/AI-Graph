...
<div class="btn-group" style="margin:20px;width:96%;margin-left:2%">
    ...
    <a href="<?php  echo $wxmoney_link;?>"><button type="button" class="btn btn-primary btn-lg">微信收益</button></a><?php  } ?>
	  <?php  if($showks=="1") { ?>
    <a href="<?php  echo $ksmoney_link;?>"><button type="button" class="btn btn-default btn-lg active">快手收益</button></a><?php  } ?>
</div>
...
window.location.href="<?php  echo $this->createWebUrl('user')?>&pt=user_money_ks&start_time="+start+"&end_time="+end;
...
window.location.href="<?php  echo $this->createWebUrl('user')?>&pt=user_money_ks&start_time="+timeArr[0]+"&end_time="+timeArr[1];
