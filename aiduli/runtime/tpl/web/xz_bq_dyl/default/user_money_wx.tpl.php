...
<button  type="button" class="btn btn-primary btn-lg" style="position:absolute;top:50px;left:100%;margin-left:-375px;background-color:#1430da;display:<?php  if($shop_db['moneymode']==1) { ?>block<?php  } else { ?>none<?php  } ?>;" onClick="getmoney()">申请提现</button>

<a href="<?php  echo $outlink;?>" style="display:<?php  if($shop_db['moneymode']==1) { ?>block<?php  } else { ?>none<?php  } ?>;"><button  type="button" class="btn btn-primary btn-lg" style="position:absolute;top:50px;left:100%;margin-left:-270px;">提现记录</button></a>
<a href="<?php  echo $backlink;?>"><button  type="button" class="btn btn-primary btn-lg" style="position:absolute;top:50px;left:100%;margin-left:-120px">返回列表</button></a>

</div>

<div class="btn-group" style="margin:20px;width:96%;margin-left:2%">
    <?php  if($showdy=="1") { ?>
	<a href="<?php  echo $dymoney_link;?>"><button type="button" class="btn btn-primary btn-lg ">抖音收益</button></a><?php  } ?>
	  <?php  if($showwx=="1") { ?>
    <a href="<?php  echo $wxmoney_link;?>"><button type="button" class="btn btn-default btn-lg active">微信收益</button></a><?php  } ?>
	  <?php  if($showks=="1") { ?>
...
window.location.href="<?php  echo $this->createWebUrl('user')?>&pt=user_money_wx&start_time="+start+"&end_time="+end;
...
window.location.href="<?php  echo $this->createWebUrl('user')?>&pt=user_money_wx&start_time="+timeArr[0]+"&end_time="+timeArr[1];
