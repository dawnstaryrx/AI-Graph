...
<div class="btn-group">
    <a href="<?php  echo $this->createWebUrl('money')?>"><button type="button" class="btn btn-primary btn-lg " style="border-radius:10px 10px 0 0">抖音结算</button></a>
    <a href="<?php  echo $this->createWebUrl('money_wx')?>"><button type="button" class="btn btn-default btn-lg active" style="border-radius:10px 10px 0 0">微信结算</button></a>
...
window.location.href="<?php  echo $this->createWebUrl('Money_wx')?>&type=showorder&start_time="+start+"&end_time="+end;
...
window.location.href="<?php  echo $this->createWebUrl('Money_wx')?>&type=showorder&start_time="+timeArr_day[0]+"&end_time="+timeArr_day[1];
...
window.location.href="<?php  echo $this->createWebUrl('Money_wx')?>&type=showorder&start_time="+timeArr[0]+"&end_time="+timeArr[1];
...
$.post("<?php  echo $this->createWebUrl('download_usercode_wx')?>", {
