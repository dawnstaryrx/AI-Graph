...
<div class="btn-group">
    ...
    <a href="<?php  echo $this->createWebUrl('pay_ks')?>"><button type="button" class="btn btn-default btn-lg active" style="border-radius:10px 10px 0 0">快手收益管理</button></a>
</div>
